...
% generating offset
               ...
               sw temp3(r0), r1
               sub r1, r1, r1
% assigning lit10 to main0p with offset temp3
               lw r2, temp3(r0)
               lw r1, lit10(r0)
               sw main0p(r2), r1
               addi r1, r0, 0
...
%storing 3 into lit12
               ...
               sw lit12(r0), r1
                addi r1, r0, 0
               sub r1, r1, r1
%storing 3 into lit13
               addi r1, r0, 3
               sw lit13(r0), r1
                addi r1, r0, 0
               sub r1, r1, r1
%storing 7 into lit14
               addi r1, r0, 7
               sw lit14(r0), r1
                addi r1, r0, 0
% generating offset
               ...
               sw temp4(r0), r1
               sub r1, r1, r1
% assigning lit14 to main0p with offset temp4
               lw r2, temp4(r0)
               lw r1, lit14(r0)
               sw main0p(r2), r1
               addi r1, r0, 0
...
% getting variable at an offset
               ...
               sub r2, r2, r2
               sub r3, r3, r3
%multiplying temp6 with temp8
               lw r1, temp6(r0)
               lw r2, temp8(r0)
               mul r3, r1, r2
               sw temp9(r0), r3
               sub r1, r1, r1
% assigning temp9 to main0y
               lw r1, temp9(r0)
               sw main0y(r0), r1
               addi r1, r0, 0
               sub r1, r1, r1
...
%storing 1 into lit22
               ...
               sw lit22(r0), r1
                addi r1, r0, 0
               sub r1, r1, r1
%storing 3 into lit23
               addi r1, r0, 3
               sw lit23(r0), r1
                addi r1, r0, 0
               sub r1, r1, r1
%storing 3 into lit24
               addi r1, r0, 3
               sw lit24(r0), r1
                addi r1, r0, 0
% generating offset
...
% getting variable at an offset
               ...
               sub r2, r2, r2
               sub r3, r3, r3
%multiplying temp12 with temp14
               lw r1, temp12(r0)
               lw r2, temp14(r0)
               div r3, r1, r2
               sw temp15(r0), r3
               % processing: write(temp15)
               lw r1, temp15(r0)
               % put value on stack
               sw -8(r14), r1
